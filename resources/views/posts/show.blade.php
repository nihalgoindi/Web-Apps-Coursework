    ...
    <div class="space-y-4">
      ...
      <div class="flex">
        ...
        <div class="flex-1 border rounded-lg px-4 py-2 sm:px-6 sm:py-4 leading-relaxed">
          <strong>Username</strong> <span class="text-xs text-gray-400"></span>
          <p class="text-sm">
            Comment Text: Lorem ipsum dolor sit amet, consetetur sadipscing elitr,
